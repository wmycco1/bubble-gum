// ═══════════════════════════════════════════════════════════════
// RECENTLY COMPARED COMPONENT - M3 E-commerce
// ═══════════════════════════════════════════════════════════════
// Version: 2.0.0 - Display recently compared products
// Features:
// - Grid layout with comparison highlight
// - Product cards with image/name/price
// - "Compare Again" CTA button
// - Comparison badge
// ═══════════════════════════════════════════════════════════════
...
export function RecentlyComparedComponent({ component }: { component: CanvasComponent }) {
  ...
  const title = (props.title as string) || 'Recently Compared';
    ...
    return (
      <div className="p-8 border-2 border-dashed border-slate-300 rounded-lg bg-slate-50">
        <div className="text-center text-slate-500">
          ...
          <p className="text-sm font-medium">No recently compared products</p>
        ...
        {products.map((product) => (
          <div key={product.id} className="relative border border-slate-200 rounded-lg overflow-hidden bg-white hover:shadow-lg transition-shadow">
            ...
            <div className="p-3">
              ...
              <button className="w-full bg-orange-600 hover:bg-orange-700 text-white px-3 py-2 rounded text-xs font-medium transition-colors">
                Compare Again
              </button>
            </div>
          </div>
