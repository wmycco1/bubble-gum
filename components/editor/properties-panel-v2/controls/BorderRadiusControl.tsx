  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="px-2 py-1 text-xs border-2 border-gray-300 rounded bg-white focus:ring-2 focus:ring-blue-500 cursor-pointer"
      >
        <option value="px">px</option>
        <option value="rem">rem</option>
        <option value="em">em</option>
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <select
        ...
        className="w-14 px-1 py-0.5 text-xs border-2 border-gray-300 rounded bg-white focus:ring-2 focus:ring-blue-500 cursor-pointer"
      >
        <option value="px">px</option>
        <option value="rem">rem</option>
        <option value="em">em</option>
